...
import {
  ...
  Grid, LinearProgress, Card, CardContent, Modal, Fade, Backdrop, IconButton
} from '@mui/material';
...
export default function GoalDetailPage() {
  ...
  <ResponsiveContainer width="100%" height="90%">
    <BarChart
      ...
      margin={{ top: 30, right: 30, left: 20, bottom: 5 }} // เพิ่ม Margin ด้านบนให้มีที่สำหรับตัวเลข
    >
      <CartesianGrid strokeDasharray="3 3" />
      <XAxis dataKey="name" stroke="rgba(255, 255, 255, 0.7)" /> {/* ทำให้แกน X อ่านง่ายขึ้น */}
      <YAxis stroke="rgba(255, 255, 255, 0.7)" /> {/* ทำให้แกน Y อ่านง่ายขึ้น */}
      <Tooltip
