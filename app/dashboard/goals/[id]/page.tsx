...
import Grid from '@mui/material/Grid2'; // <-- Changed Import
import { 
        ...
        <Container maxWidth="lg" sx={{ my: 4 }}>
            ...
            <Paper sx={{ p: 2, height: 400, mb: 4 }}>
                ...
                <ResponsiveContainer width="100%" height="90%">
                    ...
                    <Bar
                        ...
                        fill="#82ca9d"
                    >
                        <LabelList dataKey="quantity" position="top" formatter={(value: number) => value > 0 ? value : ''} fill="white" fontSize={12} />
                    </Bar>
                    </BarChart>
                </ResponsiveContainer>
            </Paper>
            ...
            <Grid2 container spacing={2} sx={{ mt: 1 }}>
                {goalData.workLogs.length > 0 ? (
                    ...
                    <Grid2 item xs={12} sm={6} md={4} key={log.id}>
